	...
	internal sealed class LoadPsFilter : IDisposable
	{
	   ...
	   // static PluginData enumData;  
        ...
        static bool IgnoreAlphaChannel(PluginData data)
        {
            ...
            string[] plugins = new string[17] {"Anaglyph Flip", "ChromaSolarize","Demitone 25", "Demitone 50", 
...
//                              Debug.WriteLine("y = " + y.ToString());
		...
		static short display_pixels_proc(ref PSPixelMap source, ref VRect srcRect, int dstRow, int dstCol, System.IntPtr platformContext)
		{
#if DEBUG
