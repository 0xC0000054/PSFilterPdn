...
namespace PaintDotNet
{
          ...
          ICloneable
    {
        ...
        public unsafe long GetRowByteOffsetUnchecked(int y)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("y=" + y.ToString() + " is out of bounds of [0, " + this.height.ToString() + ")");
            }
#endif
        ...
        public long GetColumnByteOffsetUnchecked(int x)
        {
            ...
            if (x < 0 || x >= this.width)
            {
                System.Diagnostics.Debug.WriteLine("x=" + x.ToString() + " is out of bounds of [0, " + this.width.ToString() + ")");
            }
#endif
