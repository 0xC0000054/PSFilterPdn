...
{
    internal static class BinaryFilterCaseInfoParser
    {
        internal sealed class Result
        {
            ...
            public Result(FilterCaseInfoCollection? filterCaseInfo, int actualArrayLength)
            {
        ...
        internal static unsafe Result? Parse(byte* ptr, int length)
        {
            ...
            return new Result(filterInfoValid ? new FilterCaseInfoCollection(info) : null, offset);
        }
