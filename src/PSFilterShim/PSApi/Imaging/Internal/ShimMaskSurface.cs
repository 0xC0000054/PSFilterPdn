...
namespace PSFilterLoad.PSApi.Imaging.Internal
{
    ...
    internal sealed unsafe class ShimMaskSurface : MaskSurface
    {
        ...
        private ShimMaskSurface(int width ,int height, bool zeroFill)
        {
            this.width = width;
            this.height = height;
            stride = width;
        ...
        public override ShimMaskSurface Clone()
        {
            ...
            ShimMaskSurface surface = new(width, height, zeroFill: false);
        ...
        public override ShimMaskSurface CreateScaledSurface(int newWidth, int newHeight)
        {
            ...
            ShimMaskSurface surface = new(newWidth, newHeight);
            surface.FitSurface(this);
            return surface;
        }

        public override ShimMaskSurfaceLock Lock(SurfaceLockMode mode)
        {
            VerifyNotDisposed();

            return new ShimMaskSurfaceLock(scan0.VoidStar, stride, width, height);
        }

        public override  ShimMaskSurfaceLock Lock(Rectangle bounds, SurfaceLockMode mode)
        {
            VerifyNotDisposed();
            ...
            return new ShimMaskSurfaceLock(buffer, stride, bounds.Width, bounds.Height);
        }
        ...
        /// </remarks>
        private void CopySurface(ShimMaskSurface source)
        {
        ...
        /// </remarks>
        private void FitSurface(ShimMaskSurface source)
        {
